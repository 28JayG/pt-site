    ...
    <div className="w-full flex flex-col gap-10 ">
      ...
      <div className="flex justify-around px-20">
        ...
        <div className="flex flex-col gap-8">
          <div className="w-96 h-44 bg-leafGreen rounded-xl relative flex justify-center items-center">
            <img
              src="/Frame 20993.png"
              alt=""
          ...
          <div className="w-96 h-44 bg-mellowYellow rounded-xl relative flex justify-center ">
