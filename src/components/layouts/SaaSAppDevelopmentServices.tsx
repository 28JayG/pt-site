...
const SaaSAppDevelopmentServices: React.FC = () => {
  return (
...
and expert development."
        ...
        <div className="flex gap-5 my-10">
          <div className="flex flex-col gap-5 p-8 w-[645px] rounded-2xl bg-white">
            ...
            <p className="font-bold text-2xl">Saas App Development</p>
          ...
          <div className="flex flex-col gap-5 p-8 w-[645px] rounded-2xl bg-white">
            ...
            <p className="font-bold text-2xl">Saas Web Development</p>
            <p className="text-gray-600">
...
export default SaaSAppDevelopmentServices;
