        ...
        <div className="my-10 flex flex-col gap-5">
          <div className="flex gap-5 my-10">
            <div className="flex flex-col gap-5 p-8 w-[645px] rounded-2xl bg-white">
              ...
              <p className="font-bold text-2xl">Mobile Commerce Solutions</p>
          ...
          <div className="flex gap-5 my-10">
            <div className="flex flex-col gap-5 p-8 w-[645px] rounded-2xl bg-white">
              ...
              <p className="font-bold text-2xl">Custom Ecommerce Solutions</p>
              <p className="text-gray-600">
            ...
            <div className="flex flex-col gap-10 p-8 w-[645px] rounded-2xl bg-primary justify-center">
              <p className="font-semibold text-4xl text-white">
                Need any other custom ecommerce development solution?
              </p>
              <div>
